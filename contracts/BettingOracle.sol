...
contract BettingOracle {
    ...
    event GetCorrectHorseEvent(address playerAddress, uint256 id, address bettingContractAddress);
    ...
    function sendCorrectHorse(
        ...
        callerContractInstance = CallerContracInterface(_bettingContractAddress);
